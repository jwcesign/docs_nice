...
You can refer to the doc [Demostration Cluster for CloudPilot AI](https://github.com/cloudpilot-ai/examples/tree/main/clusters/eks) to create an EKS cluster easily.
