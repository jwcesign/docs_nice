...
On the cluster page, click `option` for the cluster you intend to detach from CloudPilot AI. Verify carefully before proceeding to avoid unintended cluster removal.

<div style={{ textAlign: 'center', width: '90%', margin: '0 auto', borderRadius: '8px', overflow: 'hidden' }}>
  ![cluster](./img/uninstall_0.png)
</div>
...
<div style={{ textAlign: 'center', width: '90%', margin: '8px auto', borderRadius: '8px', overflow: 'hidden' }}>
  ![uninstall-2](./img/uninstall_1.png)
</div>
...
<div style={{ textAlign: 'center', width: '90%', margin: '8px auto', borderRadius: '8px', overflow: 'hidden' }}>
  ![uninstall-2](./img/uninstall_3.png)
</div>
...
<div style={{ textAlign: 'center', width: '90%', margin: '8px auto', borderRadius: '8px', overflow: 'hidden' }}>
  ![uninstall-2](./img/uninstall_4.png)
</div>
