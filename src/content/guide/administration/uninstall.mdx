...
2. **Reduce CloudPilot resource usage**
    ...
    kubectl -n cloudpilot patch deploy cloudpilot-aws-optimizer -p '{"spec":{"template":{"spec":{"containers":[{"name":"controller","resources":{"requests":{"cpu":"300m","memory":"300Mi"},"limits":{"cpu":"500m","memory":"500Mi"}}}]}}}}'
    ```
