...
Now, **CloudPilot AI** only supports EKS(AWS), ACK(Alibaba Cloud) clusters, other cloud providers will be supported soon. If you already have a cluster, please skip this step.
